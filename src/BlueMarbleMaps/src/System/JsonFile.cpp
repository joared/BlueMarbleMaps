...
// std::string BlueMarble::JSONFile::prettyString(JsonValue* value, bool useIndentation)
// {
//     std::string s;

//     prettyString(value, s, 0, useIndentation);

//     return s;
// }


// void BlueMarble::JSONFile::prettyString(JsonValue* value, std::string& s, int indentation, bool useIndentation)
// {
...
//     {
//         auto list = value->get<JsonList>();
//         s += "[";
//         int i(0);
//         for (const auto& v : list)
//         {
//             prettyString(v, s, indentation, useIndentation);
//             if (i < list.size()-1)
//             {
//                 s += ",";
//             }
...
//             s += indentationStr;
//             s += "\"" + it.first + "\":";
//             prettyString(it.second, s, indentation+1, useIndentation);
...
//     {
//         if (level != 0)
//             std::cout << "WARNING: End of file, level: " << level << "\n";
//     }
