...
namespace BlueMarble
{
    ...
    class IFeatureDataBase
    {
        public:
            ...
            virtual FeaturePtr getFeature(const FeatureId& id) = 0;
            virtual FeatureCollectionPtr getFeatures(const FeatureIdCollectionPtr& ids) = 0;
            virtual void getFeatures(const FeatureIdCollectionPtr& ids, FeatureCollectionPtr& featuresOut) = 0;
            virtual FeatureCollectionPtr getAllFeatures() = 0;
